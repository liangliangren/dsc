...
$(function() {
    ...
    $(".brand-search-text li:not(.brand-search-oneli)").mouseover(function() {
        var that = $(this).text();
        $(".brand-search-toggle label").each(function() {
            if (that == $(this).attr("class")) {
                $(this).parent().addClass("brand-search-toggle-one").siblings("li").removeClass("brand-search-toggle-one")
            }
        })
    })
